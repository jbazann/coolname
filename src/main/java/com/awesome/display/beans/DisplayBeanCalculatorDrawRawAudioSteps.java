...
public class DisplayBeanCalculatorDrawRawAudioSteps extends DisplayBeanCalculator {
     ...
     * and the last horizontal line for the last sample.
    ...
    public DisplayBeanCalculatorDrawRawAudioSteps(final double MAX_Y,
    ...
    protected double[] calculate(final double[] target,final double[] source) {
        ...
        final double RANGE_Y = MAX_Y;//TODO write this nicely
        final double MAX_I = source.length;
        ...
        while(++i < source.length - 1)
        {
            ...
            double xCurrentSampleStart = (i+1) / MAX_I;
            double xNextSampleStart = (i+2) / MAX_I;
